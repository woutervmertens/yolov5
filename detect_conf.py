...
# 40168676
# 40168667
source = r'D:\Tests\Netting_08-08_active-learning_not-annotated'
target = r'D:\Tests\Active_learning_labels'
# source = test_source
# target = test_target
...
def run(
        ...
        name=default_name,  # save results to project/name
    ...
    # Directories
    save_dir = increment_path(Path(target) / name, exist_ok=exist_ok)  # increment run
...
def parse_opt():
    ...
    parser.add_argument('--name', default=default_name, help='save results to project/name')
